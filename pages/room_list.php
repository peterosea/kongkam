          ...
          <div class="inner_wrap">
            ...
            <div class="text_wrap">
              <ul class="_text">
                ...
                <li class="date">20.11.23 ~ 20.11.26</li>
                <li class="password">비밀번호 1252</li>
              </ul>
              <div class="label_grp">
                <span class="label _checkin">입실</span>
              </div>
            </div>
          </div>
          <div class="inner_popup">
            <?php include('roomDetailView.php') ?>
          </div>
        </div>
        <div class="room">
          <div class="inner_wrap">
